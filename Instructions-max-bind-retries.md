...
**Key Insights:**
- Use exponential backoff with cap: `(1 << (attempt - 1)).min(16)` gives 1, 2, 4, 8, 16, 16, 16... second delays
- Cap at 16 seconds prevents excessive delays for high retry counts
...
- Extract delay calculation for easy testing
